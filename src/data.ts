...
export const listingsData: Listing[] = [
  // PROPERTIES (العقارات)
  {
    ...
    detailsAr: 'تحفة معمارية رائعة تتمثل في مبنى برج ستار تاور (STAR TOWER) السكني الراقي المتميز بالهيكل الأبيض البصري الفريد والديكورات الحديثة الخلابة.',
    detailsEn: 'A magnificent towering residential structure named Star Tower. Showcasing pristine white architecture, premium blue steel cladding, gorgeous balconies, and a panoramic circular glass dome.',
    approved: false,
  },
  {
    id: 'prop-2',
    ...
    featured: true,
    date: new Date().toISOString(),
    detailsAr: 'بنتهاوس راقي يتربع فوق أعلى الأبراج السكنية على كورنيش جدة. توفر الشقة إطلالة بانورامية ساحرة',
  ...
  },
  {
    ...
    featured: false,
    date: new Date().toISOString(),
    detailsAr: 'بناء سكني مستقل ومنظم بالكامل مبني بالخرسانة والبلوك رمادي اللون المتين',
    detailsEn: 'A private multi-story structure built from sturdy grey unpainted hollow block and robust concrete columns',
    approved: false,
  },
  ...
  // CARS (السيارات)
  {
    ...
    status: 'للبيع',
    detailsAr: 'الكروس أوفر الفاخرة الأرقى عالمياً بتعديل مانسوري الحصري',
    detailsEn: 'The absolute pinnacle of luxury off-roaders customized under the elite Mansory program',
    approved: false,
  },
  {
    id: 'car-2',
    ...
    model: 'G63 AMG',
    status: 'للبيع',
    detailsAr: 'مرسيدس جي كلاس رائدة الدفع الرباعي الرياضي',
    detailsEn: 'The masterclass of off-road sportiness with precision engineering',
    approved: false,
  },
  {
    id: 'car-3',
    ...
    model: '911 Turbo S',
    status: 'للبيع',
    detailsAr: 'صاروخ بورش الأرضي فئة التوربو إس مع تسارع خارق',
    detailsEn: 'The absolute asphalt rocket with incredible twin-turbocharged boxer response',
    approved: false,
  }
];
...
export const platformStats = {
  ...
  happyClientsEn: '99% Satisfied VIP Clients',
